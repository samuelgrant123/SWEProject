...
// Extract simplified city and state string from an address object
...
// Recenter map when user coordinates change
...
// Allow user to update location by double-clicking on the map
...
export default function InteractiveMap() {
  ...
  const fallbackCenter = [28.5383, -81.3792]; // Default to Orlando, FL
  ...
  return (
    <div style={{ height: '500px', width: '100%', marginTop: '20px', position: 'relative' }}>
      ...
      >
        ...
        <LocationSelector setUserCoords={setUserCoords} setUserLocation={setUserLocation} />
        <MapCenter coords={userCoords} />
        <SearchBar setUserCoords={setUserCoords} setUserLocation={setUserLocation} />
